...
/**
 * Created by alepena01 on 9/19/16.
 */
public class FlickrFetchr {

    private static final String TAG = "FlickrFetchr";

    private static final String API_KEY = "0671c782451b28cb0a8f08d528e53af0";
    ...
    private void parseGsonItems(List<GalleryItem> items, String jsonBody)
        ...
        Gson gson = new GsonBuilder()
                .registerTypeAdapter(GalleryItem[].class, new GalleryDeserializer())
                .create();
